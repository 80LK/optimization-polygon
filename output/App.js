...
class App extends EventTarget {
    constructor() {
        super();
        this.params = new Params(location.href);
        ...
        const generator = new GeneratorPoints(new Point(10, this.height - 30), new Point(this.width - 10, this.height - 10));
        this.screens = generator.generatePages(this.pages, this.points);
        this.onKeydown = this.onKeydown.bind(this);
    }
    buildScreen(screen) {
        if (this.buildedScreen >= screen)
            return;
    ...
    nextScreen() {
        try {
            this.setScreen(this._currentScreen + 1);
        }
        catch (e) { }
    }
    prevScreen() {
